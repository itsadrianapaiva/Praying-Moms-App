...
const BentoBox: React.FC<BentoBoxProps> = ({
    ...
    return (
        <div className="mx-auto lg:p-2 h-auto">
            {/* Welcome Message - Top Section */}
            <div className="flex justify-between items-center">
            <h1 className="text-2xl lg:text-3xl font-bold mb-2 font-['Oooh_Baby']">
                Welcome, Mama!
            </h1>
            <span className="text-lg text-[#434143]">{today}</span>
            </div>

            <div className="grid grid-cols-1 grid-rows-6 lg:grid-cols-6 lg:grid-rows-6 gap-4 md:gap-4 lg:gap-4">
                ...
                <div className="col-span-1 lg:col-span-4 relative">
                    ...
                    />
                    <Search
                        className="absolute left-4 top-[29%] lg:top-[12%] transform -translate-y-1/2 text-[#643a71]"
                        size={20}
                    />
                </div>
